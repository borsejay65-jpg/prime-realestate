...
export default function EditPropertyPage() {
      ...
      .then(({ data: property, error }) => {
        ...
        if (property) {
          setForm({
            ...
            floorplan_url: property.floorplan_url || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await updatePropertyAction(id, updatedProperty, images)
      if (res.success) {
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="card p-6 space-y-4">
            <h2 className="text-lg font-bold text-gray-855 dark:text-white mb-2 border-b border-gray-100 dark:border-gray-800 pb-2">Basic Info</h2>
          ...
          {/* Specifications */}
          <div className="card p-6 space-y-4">
            <h2 className="text-lg font-bold text-gray-855 dark:text-white mb-2 border-b border-gray-100 dark:border-gray-800 pb-2">Specs & Details</h2>
            ...
            <div className="flex flex-col gap-3">
              <label className="flex items-center gap-2 cursor-pointer text-sm">
                <input
                  ...
                  className="w-4 h-4 rounded text-gold focus:ring-gold border-gray-300"
                />
                <span className="font-semibold text-gray-700 dark:text-gray-355">Active / Published Listing</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer text-sm">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 rounded text-gold focus:ring-gold border-gray-300"
                />
                <span className="font-semibold text-gray-700 dark:text-gray-355">Feature on Homepage</span>
              </label>
            </div>
          </div>
