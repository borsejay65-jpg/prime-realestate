...
INSERT INTO locations (city, area, state, pincode) VALUES
  ('Pune', 'Baner', 'Maharashtra', '411045'),
  ('Pune', 'Wakad', 'Maharashtra', '411057'),
  ('Pune', 'Hinjewadi', 'Maharashtra', '411057'),
  ('Pune', 'Kothrud', 'Maharashtra', '411038'),
  ('Pune', 'Kalyani Nagar', 'Maharashtra', '411006'),
  ('Pune', 'Viman Nagar', 'Maharashtra', '411014'),
  ('Pune', 'Aundh', 'Maharashtra', '411007'),
...
INSERT INTO faqs (question, answer, category, display_order) VALUES
  ...
  ('Is PrimeAxis a verified real estate brokerage?', 'Yes, PrimeAxis is a registered and verified real estate brokerage with years of experience in the Pune property market. All our listings are verified and our team of experts guides you through every step.', 'general', 2),
...
INSERT INTO testimonials (customer_name, rating, review, property_type, location, display_order) VALUES
  ('Rajesh Sharma', 5, 'PrimeAxis made our dream of owning a home in Pune a reality. Their team was professional, transparent, and guided us through every step. We found our perfect 3BHK in Baner within 3 weeks!', 'Apartment', 'Baner, Pune', 1),
  ('Priya Mehta', 5, 'Excellent service from start to finish. The agents are knowledgeable and never pushed us into any decisions. The loan assistance they provided saved us significant time and effort.', 'Independent House', 'Kothrud, Pune', 2),
  ('Vikram Patel', 4, 'Very professional team. They showed us properties that truly matched our budget and requirements. The legal assistance was a huge help. Highly recommend PrimeAxis for anyone looking to invest in Pune real estate.', 'Commercial', 'Hinjewadi, Pune', 3),
  ('Anita Desai', 5, 'I was skeptical about buying property remotely, but PrimeAxis made it seamless. Regular updates, video tours, and thorough documentation support. Truly a premium experience!', 'Luxury Villa', 'Kalyani Nagar, Pune', 4),
  ('Suresh Kumar', 5, 'Found our dream farmhouse through PrimeAxis. The team understood exactly what we wanted and presented us with options that exceeded our expectations. The negotiation support saved us lakhs!', 'Farm House', 'Pune Outskirts', 5),
  ('Neha Singh', 4, 'Great experience overall. PrimeAxis has a vast network of verified properties. Their after-sales support continues even after the deal is closed. Very trustworthy brokerage.', 'Apartment', 'Viman Nagar, Pune', 6);

-- Carousel Slides
INSERT INTO carousel_slides (title, subtitle, slide_type, media_url, button_text, button_url, display_order) VALUES
  ('Find Your Dream Property in Pune', 'Verified listings, expert guidance, and the best deals across residential and commercial properties', 'image', '/images/hero-1.jpg', 'View Properties', '/properties', 1),
  ...
  ('Smart Investment, Better Future', 'Discover high-yield commercial properties and prime plots in Pune''s growth corridors', 'image', '/images/hero-3.jpg', 'Invest Now', '/properties?type=commercial', 3);

-- Site Settings
INSERT INTO site_settings (key, value, description) VALUES
  ('company_name', 'PrimeAxis', 'Company name'),
  ('company_tagline', 'Your Trusted Real Estate Partner', 'Company tagline'),
  ('company_description', 'PrimeAxis is Pune''s premier real estate brokerage firm specializing in residential, commercial, and luxury properties. With years of market expertise and a dedicated team of professionals, we help you find the perfect property.', 'Company description'),
  ...
  ('address', 'PrimeAxis Realty Pvt. Ltd., Office No. 101, Premium Business Park, Baner Road, Pune - 411045, Maharashtra, India', 'Office address'),
  ...
  ('seo_title', 'PrimeAxis | Premium Real Estate Brokerage in Pune', 'Default SEO title'),
  ('seo_description', 'Find your dream property in Pune with PrimeAxis. Expert real estate brokerage for residential, commercial, luxury villas, plots, and rental properties. Call +91 9511802062.', 'Default SEO description'),
  ('google_maps_embed', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.019073773987!2d73.83291021485!3d18.559473787381!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf61fdc6f!2sBaner%2C+Pune!5e0!3m2!1sen!2sin!4v1625000000000!5m2!1sen!2sin', 'Google Maps embed URL'),
